...
function UpdateEvent() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        await axios.put(
          `http://localhost:5000/events/update/${eventId}`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      <div className="container mx-auto max-w-2xl">
        <div className="bg-white shadow-2xl rounded-2xl overflow-hidden">
          <div className="bg-blue-600 text-white p-6 flex items-center">
            ...
            <h1 className="text-2xl font-extrabold">Update Event</h1>
          </div>
...
//               <PlusCircle className="mr-3" size={36} />
//               <h1 className="text-2xl font-extrabold">Update Sports Event</h1>
//             </div>
